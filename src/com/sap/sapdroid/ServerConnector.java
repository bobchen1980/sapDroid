...
import com.sap.ampache.CachedData;
...
public class ServerConnector implements Serializable {
	...
	public boolean isConnected(boolean network) {
		...
		try {
			...
			Log.d("error", "server connect error");
			e.printStackTrace();
		}
		return false;
	}
